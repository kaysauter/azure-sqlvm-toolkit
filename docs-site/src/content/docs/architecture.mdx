...
The next architecture milestone is a mechanical deployment-engine split following the refactoring plan, plus live Azure integration evidence for reruns, drift scenarios, and `-WhatIf` output.
